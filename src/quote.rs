...
fn base_to_quote_lots(
    ...
    let quote_atoms = market.base_lots_to_quote_atoms(BaseLots::new(base_lots), Ticks::new(price_ticks))?;
...
mod tests {
    ...
    use archer_sdk::onchain::{
        BaseAtomsPerLot, MakerBookStatus, MakerLevel, QuoteAtomsPerBaseUnitPerTick,
    ...
    fn empty_book(active: bool) -> MakerBook {
        MakerBook {
            ...
            status: if active { MakerBookStatus::Active.as_u8() } else { 2 },
            maker_book_bump: 0,
